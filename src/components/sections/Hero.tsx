    ...
    <section className="relative min-h-screen flex items-center pt-20 overflow-hidden">
      <div className="absolute inset-0 z-0">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(#79D88F 0.5px, transparent 0.5px)",
      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
        ...
        >
          ...
          <h3 className="text-lg text-soft-white/60 mb-4 font-light tracking-wide uppercase">
            Frontend Engineer | React | Node.js | Cloud | CI/CD | AI
          </h3>
          ...
          <p className="text-xl text-soft-white/60 mb-8 max-w-xl leading-relaxed">
            Software engineer with 4+ years of experience building modern web
          ...
          <div className="flex flex-wrap gap-4 items-center mb-10 text-soft-white/40 text-sm font-medium">
            <span className="flex items-center gap-1.5">
              <Globe size={16} className="text-accent" /> React.js
            </span>
            <span className="w-1 h-1 rounded-full bg-white/20" />
            <span className="flex items-center gap-1.5">
              <Server size={16} className="text-accent" /> Node.js
            </span>
            <span className="w-1 h-1 rounded-full bg-white/20" />
            <span className="flex items-center gap-1.5">
              <Cloud size={16} className="text-accent" /> Cloud
            </span>
            <span className="w-1 h-1 rounded-full bg-white/20" />
            <span className="flex items-center gap-1.5">
              <Cpu size={16} className="text-accent" /> AI
            </span>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <a
              href="#projects"
              className="px-8 py-4 bg-accent text-navy-900 rounded-xl font-bold flex items-center justify-center gap-2 hover:glow-green transition-all group"
            >
              View Projects
              <ChevronRight
                size={20}
            ...
            <a
              href="#contact"
              className="px-8 py-4 bg-white/5 border border-white/10 rounded-xl font-bold flex items-center justify-center gap-2 hover:bg-white/10 transition-all"
            >
              Contact Me
            </a>
          </div>
